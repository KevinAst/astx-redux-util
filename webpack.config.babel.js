...
// ... ex: FROM: 'astx-redux-util' TO: 'AstxReduxUtil'
const libraryName = () => {
...
const webpackConfig = {
  ...
  output: {
    ...
    filename:      packageInfo.name + (productionEnv ? '.min.js' : '.js'), // bundleFileName ... ex: astx-redux-util.min.js

    library:       libraryName(), // bundle as a library (i.e. for external consumption) ....... ex: AstxReduxUtil
